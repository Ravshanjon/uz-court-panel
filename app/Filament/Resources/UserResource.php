                ...
                Forms\Components\Card::make()->schema([
                    Forms\Components\Grid::make(2)->schema([
                        Select::make('type_of_users_id')
                            ...
                            ->relationship('typeOfUser', 'name')
                            ->live(),

                        Fieldset::make('Foydalanuvchi formasi')
                            ->visible(fn(Get $get) => (int)$get('type_of_users_id') === 1)
                            ->schema([
                        ...
                        Fieldset::make('Kuzatuvchi formasi')
                            ->visible(fn(Get $get) => (int)$get('type_of_users_id') === 2)
                            ->schema([
                                TextInput::make('email')
                                    ->label('Email')
                                    ->default(function () {
...
//            ])
            ...
            ->defaultGroup('region.name') // 🌟 Viloyatlar bo‘yicha guruhlash
            ->groups([
                Group::make('region.name')->label('Ҳудуд'),
            ])
            ->filters([
                //
            ])
